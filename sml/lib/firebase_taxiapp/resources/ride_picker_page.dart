...
import 'package:flutter_app/firebase_taxiapp/blocs/place_bloc.dart';
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        height: 60,
                        child: Center(
                          child: Image.asset("taxi/ic_location_black.png"),
                        ),
                      ),
                      Positioned(
                        right: 0,
                        ...
                        child: Center(
                          child: FlatButton(
                              ...
                              child: Image.asset("taxi/ic_remove_x.png")),
                        ),
                      ),
                      Padding(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              title: Text(places.elementAt(index).name == null
                                  ? ''
                                  : Text(places.elementAt(index).name)),
                              subtitle: Text(
