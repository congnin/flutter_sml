...
import 'package:ps5_neumorphic_app_ui/bloc/item_bloc.dart';
import 'package:ps5_neumorphic_app_ui/bloc/item_event.dart';
import 'package:ps5_neumorphic_app_ui/bloc/item_state.dart';
import 'package:ps5_neumorphic_app_ui/model/controller.dart';
import 'package:ps5_neumorphic_app_ui/model/option.dart';
import 'package:ps5_neumorphic_app_ui/pages/details_page.dart';
import 'package:ps5_neumorphic_app_ui/pages/homepage/item_card_shape.dart';
...
class _ItemsWidget extends StatelessWidget {
  ...
  const _ItemsWidget({Key key, this.items, this.screenWidth, this.screenHeight})
      : super(key: key);
        ...
        children: <Widget>[
          ClayContainer(
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(
                    color: iconBackgroundColor.withOpacity(0.3), width: 2),
