...
class ShowSimpleMap extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ShowSimpleMapState();
}
...
class _ShowSimpleMapState extends State<ShowSimpleMap> {
  ...
  Future<void> _goToIntel() async {
    ...
    mapController.animateCamera(CameraUpdate.newCameraPosition(intelPosition));
  }
  ...
  Marker portlandMarkerSecond = Marker(
      markerId: MarkerId("Portland"),
      position: _anotherLocation,
      infoWindow:
          InfoWindow(title: "Portland Area", snippet: "This is a great town!"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueMagenta));
}
